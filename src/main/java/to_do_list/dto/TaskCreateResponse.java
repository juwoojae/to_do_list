...
public class TaskCreateResponse {
    ...
    public TaskCreateResponse(Long id, LocalDateTime deadline, Project project, TaskCategory taskCategory, String name, TaskStatus taskStatus, String description) {
        this.id = id;
